...
|--------|-----------|-------------|------|------|--------|-----------|------------|
| gpt-oss-20b | Рассуждения | MXFP4 (MoE) | 11.5 ГБ | 11663 МБ | 1087 т/с | 118.2 т/с | Быстрая, но устаревшая модель — MoE 3B активных |
| **Qwen3.6-35B-A3B** | Рассуждения | Q2_K_XL | 12 ГБ | 12356 МБ | 497 т/с | **106.2 т/с** | **Текущая модель рассуждений** - MoE 35B (3B активных) |
...
> **Qwen3.6-35B-A3B для рассуждений:** Архитектура MoE (35B общих, ~3B активных) обеспечивает **106 т/с** — всего на 10% медленнее gpt-oss-20b. Лучший вариант, если качество gpt-oss-20b недостаточно.
