...
- 🎨 **Генерация изображений** – создание изображений из текста через stable-diffusion.cpp с автоматической оптимизацией промптов
- ✏️ **Редактирование изображений** – загрузите изображение и попросите изменить его (модель Qwen Image Edit: смена цветов, удаление объектов, стилизация) – создание картинок по тексту через stable-diffusion.cpp с оптимизацией промптов
...
| **SQLite** | Учётные записи, сессии, сообщения | Встроенный SQL | – |
...
### Piper TTS (без изменений с v7.5)
...
Модуль камер подключается к отдельному сервису `room-snapshot-api`. См. [services/README.md](services/README.md) для инструкций.
