...
| **Роутер не направляет код-запросы не туда** | Уточнён промпт роутера: запросы, связанные с программированием/кодом, больше никогда не классифицируются как генерация изображений или видео — им отвечает модель рассуждений, а не SD/LTX. |
