...
- 🔬 **Глубокий анализ (RLM)** – переключатель для глубокого анализа больших документов: модель рассуждений программно изучает выбранные вами документы через песочницу Python, вызов под-модели и веб-lookup; вся задача целиком — одна GPU-задача с трансляцией прогресса и развёрнутой сводкой шагов
