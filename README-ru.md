...
- ✏️ **Редактирование изображений** – загрузите изображение и попросите изменить его (модель Flux.2 Klein 4B: смена цветов, удаление объектов, стилизация) – создание картинок по тексту через stable-diffusion.cpp с оптимизацией промптов
