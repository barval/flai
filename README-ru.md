...
| **Qwen3VL-8B-Instruct** | Мультимодальная | Q4_K_M | 4.7 ГБ | 5292 МБ | 2318 т/с | **73.1 т/с** | Визуальная модель — текущая (самая быстрая) |
...
├── Qwen3-4B-Instruct-2507-Q4_0.gguf          # Чат
├── gemma-4-E4B-it-Q4_0.gguf                   # Рассуждения (8/12 ГБ)
├── gpt-oss-20b-Q4_K_M.gguf                    # Рассуждения (16+ ГБ)
...
|-----------|-------------|---------------------------|------------|
| **Чат** | Qwen3-4B-Instruct-2507 Q4_0 (~2.4 ГБ) | Qwen3-4B-Instruct-2507 MXFP4 (~2 ГБ) | Модель без рассуждений. MXFP4 эффективнее на Blackwell GPU (RTX 5060 Ti) |
| **Рассуждения (8/12 ГБ)** | Gemma 4 E4B Q4_0 (~4.8 ГБ) | — | Лучший баланс скорость/качество для средних GPU |
| **Рассуждения (16+ ГБ)** | gpt-oss-20b MXFP4 (~11.5 ГБ) | Qwen3.6-35B-A3B Q2_K_XL (~12 ГБ) | MoE: ~3B активных параметров, ~118 т/с |
...
- **Обновлена чат-модель** — Qwen3-4B-Instruct-2507 Q4_0 (~2.4 ГБ), дефолтный ctx 8192 → 16384. MXFP4-вариант доступен для Blackwell GPU
...
|--------|-----------|---------|--------------|
| **Qwen3-4B-Instruct-2507-Q4_0.gguf** | Чат (быстрые ответы) | [Apache 2.0](https://huggingface.co/unsloth/Qwen3-4B-Instruct-2507-GGUF) | ~2.4 ГБ |
