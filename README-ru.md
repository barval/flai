...
> **Qwen3.6-35B-A3B как альтернатива для рассуждений:** Архитектура MoE (35B общих, ~3B активных) обеспечивает **106 т/с** — всего на 10% медленнее gpt-oss-20b. Потребление VRAM 12 ГБ позволяет сосуществовать с чат-моделью через llama-swap. Сильный кандидат, если качество gpt-oss-20b недостаточно.
