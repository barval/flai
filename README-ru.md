...
- **SuperLocalMemory (SLM)** — долговременная кросс-сессионная память, daemon-режим, per-user изоляция SQLite, задержка recall ~1 мс, автоматическая очистка осиротевших memories (фоновый поток каждый час)
