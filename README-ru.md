...
|-------------|------------|
| **v11.3 — качество контекста и поиска** | В разработке: умный бюджет контекста для истории сообщений, более качественный RAG и веб-поиск, более плотная долговременная память SLM — цель: точная выдача поиска и длинные чат-сессии, удерживающие нить диалога без потери смысла предыдущей переписки. |
...
### 🔄 В работе
- **v11.3 — качество контекста и поиска** — умный бюджет контекста для истории сообщений, более качественный RAG и веб-поиск, более плотная долговременная память SLM: точная выдача поиска и длинные чат-сессии, удерживающие нить диалога без потери смысла предыдущей переписки
