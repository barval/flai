...
self.redis = redis.from_url(redis_url, decode_responses=False, socket_connect_timeout=5, socket_timeout=5)
...
self.app.logger.warning(f"Redis connection attempt {attempt + 1}/{max_retries} failed: {e}")
