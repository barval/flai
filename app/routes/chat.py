...
from app.db import get_user_documents, get_user_sessions
...
def chat():
    ...
    embedding_model = current_app.config.get("MODEL_CONFIGS", {}).get("embedding", {}).get(
        "model_name"
    ) or current_app.config.get("EMBEDDING_MODEL", "")
