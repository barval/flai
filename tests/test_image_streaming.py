...
class TestImageOnlyStreamErrorRouting:
    ...
    def test_image_only_stream_publishes_normal_tokens(self, test_app, mock_multimodal_ok):
    ...
    def test_image_only_stream_routes_error_to_build_error_response(self, test_app, mock_multimodal_error):
...
class TestImageTextStreamErrorRouting:
    ...
    def test_image_text_stream_routes_late_error_to_build_error_response(self, test_app, mock_multimodal_error_late):
